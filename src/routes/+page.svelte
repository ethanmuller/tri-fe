...
<main>
	{#each data.posts as post}
	  {#if isPublic(post.tags) && isAudio(post.tags) && post.file}
	    <div class="c-post"><audio controls src="{post.file.url}"></audio><div class="c-post__text">{post.notes}</div><a href="{post.file.url}" class="c-post__dl"><img src="/download.gif" alt="download" /></a></div>
	  {/if}
	{/each}
</main>
